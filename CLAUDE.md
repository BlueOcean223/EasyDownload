...
- **`internal/download/`** — Download engine with platform-specific implementations:
  ...
  - `douyin/` — Douyin downloader (Parser→Client→Downloader pattern, album support).
...
- **Parser→Client→Downloader**: Douyin and Xiaohongshu modules follow this 3-layer pattern — URL parsing, API client, download execution.
